...
<h1 class="display-2">Dziękujemy za wypełnienie ankiety!</h1>
<button type="button" onclick="window.history.back();" class="btn btn-primary text-center btn-lg mt-5">Wróć</button>
